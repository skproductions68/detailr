                  ...
                  <div key={stage.id} className="flex gap-4">
                    <div className="flex flex-col items-center">
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold border-2 flex-shrink-0 transition-all ${
                             ...
                             : active ? "border-white text-white shadow-[0_0_0_4px_rgba(255,255,255,0.08)]"
                    ...
                    <div className="pb-7">
                      ...
                      {active && <div className="text-[10px] font-mono text-blue-400 mt-0.5 tracking-widest">IN PROGRESS</div>}
